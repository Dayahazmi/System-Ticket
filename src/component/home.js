...
const Home = () => {
  return (
    <div className="text-black p-8 flex flex-col items-center">
      ...
      <div className="mb-8 w-full flex justify-center">
        <textarea className="ml-2 border border-black" rows={2.5} cols={78} placeholder="Subject"></textarea>
      </div>

      <div className="mb-8 w-full flex justify-center">
        <textarea className="ml-2 border border-black" rows={10} cols={78} placeholder="Please type your issue here"></textarea>
      </div>
